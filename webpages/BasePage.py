...
class BasePage:
    ...
    def click(self, locator):
        ...
        try:
            ...
            print(f"ERROR: Unable to click on element with locator '{locator}'. Exception: {e}")
            raise
    ...
    def type(self, locator, keyword):
        ...
        try:
            ...
            print(f"ERROR: Unable to type '{keyword}' into element with locator '{locator}'. Exception: {e}")
            raise
    ...
    def locate_element(self, locator):
        ...
        try:
            ...
            print(f"ERROR: Unable to find element with locator '{locator}'. Exception: {e}")
            raise
    ...
    def check_element(self, locator):
        ...
        try:
            ...
            print(f"ERROR: Element with locator '{locator}' is not present. Exception: {e}")
            raise
    ...
    def check_elements(self, locator):
        ...
        try:
            ...
            print(f"ERROR: Elements with locator '{locator}' are not present. Exception: {e}")
            raise
    ...
    def is_logo_visible(self, locator):
        ...
        try:
            ...
            print(f"ERROR: Logo not found or not visible within the timeout period. Exception: {e}")
            raise
    ...
    def is_text_visible(self, locator, text):
        ...
        try:
            ...
            print(f"ERROR: Element not found or text not visible within the timeout period. Exception: {e}")
            raise
    ...
    def get_element_text(self, locator):
        ...
        try:
            ...
            print(f"ERROR: Unable to retrieve text from element within the timeout period. Exception: {e}")
            raise
    ...
    def get_element_text_with_index(self, locator, index):
        ...
        try:
            ...
            if index < len(elements):
                ...
                print(f"WARNING: Index '{index}' is out of range for elements with locator '{locator}'.")
                return None
        except (TimeoutException, NoSuchElementException) as e:
            print(f"ERROR: Unable to retrieve elements with locator '{locator}'. Exception: {e}")
            raise
    ...
    def move_to_element(self, locator):
        ...
        try:
            ...
            print(f"ERROR: Unable to move to element with locator '{locator}'. Exception: {e}")
    ...
    def move_to_element_and_click(self, locator):
        ...
        try:
            ...
            print(f"ERROR: Unable to hover and click on element with locator '{locator}'. Exception: {e}")
    ...
    def check_and_switch_to_frame(self, locator):
        ...
        try:
            ...
            print(f"ERROR: Unable to switch to frame with locator '{locator}'. Exception: {e}")
    ...
    def move_to_element_using_js(self, locator):
        ...
        try:
            ...
            print(f"ERROR: Unable to scroll to element with locator '{locator}'. Exception: {e}")
    ...
    def get_attribute(self, locator, attribute):
        ...
        try:
            ...
            print(f"ERROR: Unable to retrieve attribute '{attribute}' from element with locator '{locator}'. Exception: {e}")
            raise
    ...
    def len_of_direct_child_element(self, locator):
        ...
        try:
            ...
            time.sleep(1)
            direct_child_elements = WebDriverWait(parent_element, 10).until(EC.visibility_of_all_elements_located((By.XPATH, "./*")))
            print(f"INFO: Number of direct child elements for '{locator}': {len(direct_child_elements)}")
            return len(direct_child_elements)
        except NoSuchElementException as e:
            print(f"ERROR: Parent element with locator '{locator}' not found. Exception: {e}")
            return 0
